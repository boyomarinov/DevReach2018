...
##### Jen Looper | Human vs. AI: BUild a Mobile App with Vue.js, ML Kit and Native Script
 ...
 - [Jen Looper's ML comparisons | Twitter](https://twitter.com/teenybiscuit/status/707727863571582978)
...
##### Jonathan Mills | Building Progressive Web Apps with React
 ...
 - Two easy steps to bring web app to 90% PWA success rate in Audit
    + service workers
        ...
        + as a rule of thumb always load when network is available, cache only as fallback
    + manifest
        + the thing you need to declare to "install" your webapp on a device
        + weird additional steps on IOS
        + Microsoft might never allow it. Rumor has it they fear too much for their Windows Store apps
...
##### Jeff Strauss | What You Need to Know About Open Source
 ...
 - BSD
    ...
    - 3-BSD
        + non-endorsement
        + advertisement - you need to give everywhere credit to all contributors (imagine if they are a lot of them)
    - no patent
 - Apache
    + patent!
    + patent assert - basically if you burn me, you loose your patent
 - GPL
    + true copyleft
    + products can only be GPS when distributed
    + in other words, product built on GPL becomes open-source
    + LGPL (less restrictive), AGPS (more)
...
##### Jonathan Mills | Solid In JS
 ...
 - [Solid Hackernoon article](https://hackernoon.com/solid-principles-made-easy-67b1246bcdf)
...
##### Natalia Tepluhina | Angular Features in VueJS
 ...
 - RxJS
    + [Observables<T>](https://angular.io/guide/observables) - next level promise, reactive
...
##### Tara Manicsic | Everything You Need to Node
 ...
 - she mentioned she rapped last time, but refused to do so this time 
 ...
 - misc: too much of her dog in this lecture (and apparently he is called Tosh-my-gosh)
...
##### Aysegul Yonet | Building WebXR Applicaions in Practice
 ...
 - misc: a lot of information and links, she managed to complete the presentation 20 mins earlier
